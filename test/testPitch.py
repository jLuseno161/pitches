...
class TestPitch(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_user = User(username = "jojo")
        self.new_pitch = Pitch(pitch_title = "funney", user = self.new_user)
    ...
    def test_init(self):
        ...
        self.assertEquals(self.new_pitch.title, "funney")
